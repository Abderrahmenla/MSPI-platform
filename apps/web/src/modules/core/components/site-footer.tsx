...
const SOCIALS = [
  ...
  {
    label: 'Facebook',
    href: 'https://facebook.com/mspi.tn',
    icon: (
      <svg
        viewBox="0 0 24 24"
        fill="currentColor"
  ...
  {
    label: 'Instagram',
    href: 'https://instagram.com/mspi.tn',
    icon: (
      <svg
        viewBox="0 0 24 24"
        fill="currentColor"
    ...
    <footer className="bg-[#0a0a0a] py-12 text-white">
      <div className="mx-auto max-w-7xl px-4 md:px-6">
        ...
        <Link
          ...
          aria-label="MSPI Fire Safety"
        >
          <span className="text-brand-500 text-xl leading-none">🔥</span>
          <span className="text-lg">MSPI</span>
        </Link>
        ...
        <p className="text-sm text-white/50">
          {locale === 'ar'
            ? `© ${year} MSPI. جميع الحقوق محفوظة.`
            : locale === 'fr'
              ? `© ${year} MSPI. Tous droits réservés.`
              : `© ${year} MSPI. All rights reserved.`}
        </p>
      </div>
    </footer>
  );
